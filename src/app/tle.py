...
from src.app import satnogs
from pymemcache.client import base
import ast

# config for heroku memcache
# import os import bmemcached mc = bmemcached.Client(os.environ.get(
# 'MEMCACHEDCLOUD_SERVERS').split(','), os.environ.get('MEMCACHEDCLOUD_USERNAME'), os.environ.get(
# 'MEMCACHEDCLOUD_PASSWORD'))

# config for local memcache
